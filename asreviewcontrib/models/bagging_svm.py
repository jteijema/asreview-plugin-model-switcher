...
class Bagging_SVMClassifier(BaseTrainClassifier):
    """
    ...
    def __init__(self,
                 ...
                 random_state=None,
                 n_estimators=10):
        super(Bagging_SVMClassifier, self).__init__()
        self.gamma = gamma
        ...
        self._model = BaggingClassifier(SVC(
            kernel=kernel,
            C=C,
            class_weight=_set_class_weight(class_weight),
            random_state=random_state,
            gamma=gamma,
            probability=True), max_samples=1.0 / n_estimators, n_estimators=n_estimators)
